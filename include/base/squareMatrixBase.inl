...
#define SQUARE_MATRIX_BASE_EQ typename SQUARE_MATRIX_BASE::EqType
...
SQUARE_MATRIX_BASE_TEMPLATE_PARAMETERS  
constexpr SQUARE_MATRIX_BASE_EQ SQUARE_MATRIX_BASE::getTransposed() const noexcept
{
    SQUARE_MATRIX_BASE_EQ returnedMatrix;
...
SQUARE_MATRIX_BASE_TEMPLATE_PARAMETERS  
constexpr SQUARE_MATRIX_BASE_EQ SQUARE_MATRIX_BASE::identity() noexcept
{
    constexpr SQUARE_MATRIX_BASE_EQ returnedMatrix = Core::Maths::SquareMatrixBase<SelfType, getSize(), ELEM_TYPE>::zero();
...
SQUARE_MATRIX_BASE_TEMPLATE_PARAMETERS
constexpr SQUARE_MATRIX_BASE_EQ SQUARE_MATRIX_BASE::getComatrix() const noexcept
{
    SQUARE_MATRIX_BASE_EQ comatrix;
...
SQUARE_MATRIX_BASE_TEMPLATE_PARAMETERS
inline constexpr SQUARE_MATRIX_BASE_EQ SQUARE_MATRIX_BASE::getAdjoint() const noexcept
{
    return getComatrix().transpose();
}

SQUARE_MATRIX_BASE_TEMPLATE_PARAMETERS
inline constexpr SQUARE_MATRIX_BASE_EQ SQUARE_MATRIX_BASE::getInverse() const noexcept
{
...
inline constexpr SQUARE_MATRIX_BASE_EQ SQUARE_MATRIX_BASE::resolveEquation(const OTHER_MATRIX& result) const noexcept
